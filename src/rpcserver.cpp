...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* tele features */
        {"tele", "masternode", &masternode, true, true, false},
        {"tele", "masternodelist", &masternodelist, true, true, false},
        {"tele", "mnbudget", &mnbudget, true, true, false},
        {"tele", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"tele", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tele", "mnsync", &mnsync, true, true, false},
        {"tele", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"tele", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use teled, or the -server option to tele-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> tele-cli " + methodname + " " + args + "\n";
}
