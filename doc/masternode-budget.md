...
tele now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<tele_address\> \<monthly_payment_tele\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ TELE, _12_ times over the course of a year totaling _24000_ TELE.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<tele_address\> \<monthly_payment_tele\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` TELE.
 ...
 * vote-many          - Vote on a tele initiative
 * vote-alias         - Vote on a tele initiative
 * vote               - Vote on a tele initiative/budget
