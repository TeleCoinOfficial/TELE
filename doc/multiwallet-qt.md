...
In order to support loading of multiple wallets in tele-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tele.cpp.
...
Changes to tele.cpp
----------------------
tele.cpp is the entry point into tele-qt, and as such, will require some minor modifications to provide hooks for
