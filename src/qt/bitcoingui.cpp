...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a tele address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tele: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tele"), this);
    aboutAction->setStatusTip(tr("Show information about Tele"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for tele"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your tele addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified tele addresses"));
    ...
    openAction->setStatusTip(tr("Open a tele: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tele help message to get a list with possible command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Tele client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to tele network", "", count));
}
...
{
    QString strTitle = tr("Tele"); // default title
