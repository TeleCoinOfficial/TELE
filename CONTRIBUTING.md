...
The following applies to code changes to the TELE project, and is not to be
confused with overall TELE Network Protocol consensus changes.

Whether a pull request is merged into TELE rests with the project merge
...
Patches that change TELE consensus rules are considerably more involved than
...
Where a patch set proposes to change the TELE consensus, it must have been
...
The project leader is the release manager for each TELE release.
