...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/mammix2/tele/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign TELE for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit tele=v${VERSION} ../tele/contrib/gitian-descriptors/gitian-osx.yml
...
Codesigner only: Sign the osx binary:
    ...
    transfer tele-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [tele-detached-sigs](https://github.com/mammix2/tele/tele-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the www.telecoin.info server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/mammix2/tele/releases/new) with a link to the archived release notes.
