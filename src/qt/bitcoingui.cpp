                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Tele Team") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tele Team"), this);
    aboutAction->setStatusTip(tr("Show information about Tele Team"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Tele Team help message to get a list with possible command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Tele Team client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Tele Team"); // default title
